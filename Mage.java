...
public class Mage extends Character {
    ...
    public Mage() {
        ...
        // this.abilities.get(0).setHealthRecovery(0);
        // this.abilities.get(0).setEPrecovery(0);
        ...
        // this.abilities.get(1).setHealthRecovery(0);
        // this.abilities.get(1).setEPrecovery(0);
        ...
        // this.abilities.get(2).setHealthRecovery(0);
        // this.abilities.get(2).setEPrecovery(15);
        ...
        // this.abilities.get(3).setHealthRecovery(40);
        // this.abilities.get(3).setEPrecovery(0);
        ...
        // this.abilities.get(4).setHealthRecovery(0);
        // this.abilities.get(4).setEPrecovery(0);
    }
    ...
    /* METHODS */
    public void arcaneBolt(Player player1, Player player2, int move) {
        player2.getChosenCharacter().setHP(player2.getChosenCharacter().getHP() - player1.getChosenCharacter().abilities.get(move).getAttackDamage());
        player1.getChosenCharacter().setEP(player1.getChosenCharacter().getEP() - player1.getChosenCharacter().abilities.get(move).getEPCost());
    }

    public void arcaneBlast(Player player1, Player player2, int move) {
        player2.getChosenCharacter().setHP(player2.getChosenCharacter().getHP() - player1.getChosenCharacter().abilities.get(move).getAttackDamage());
        player1.getChosenCharacter().setEP(player1.getChosenCharacter().getEP() - player1.getChosenCharacter().abilities.get(move).getEPCost());
    }

    public void manaChannel(Player player1, Player player2) {
        player1.getChosenCharacter().setEP(player1.getChosenCharacter().getHP() + 15);
    }

    public void lesserHeal(Player player1, Player player2) {
        player1.getChosenCharacter().setEP(player1.getChosenCharacter().getHP() + 40);
    }
